	...
	public AdminLogin() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(usernameText.getText().equalsIgnoreCase("Thilak") && passwordText.getText().equals( "admin")) {
					JOptionPane.showMessageDialog(null, "Successful login hello Thilak");
					user = "Thilakraj Shetty";
					AdminPage obj = new AdminPage(user);
					obj.setVisible(true);
				}else if(usernameText.getText().equalsIgnoreCase("Rohith") && passwordText.getText().equals( "admin")) {
					JOptionPane.showMessageDialog(null, "Successful login hello Rohith");
					user = "Rohith Nayak";
					AdminPage obj = new AdminPage(user);
					obj.setVisible(true);
				}else {
